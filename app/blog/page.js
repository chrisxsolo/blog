                  ...
                  <div key={sectionIndex} className={styles['content-section']}>
                    ...
                    {section.type === 'text' && (
                      <div className={styles['content-text']}>
                        ...
                        <p>
                          {/* If the blog post is expanded, show the full text */}
                          {/* Otherwise, show the first 400 characters of the text */}
                          {expandedPosts[index] ? section.text : section.text.slice(0, 400)}
                        </p>
      
                        {/* Check if the text is long enough to require a "Read More" button */}
                        {section.text.length > 200 && (
                          <div className={styles['read-more-container']}>
                            ...
                            <button onClick={() => handleReadMoreClick(index)} className={styles['read-more']}>
                              {/* If the blog post is expanded, show "Collapse", otherwise show "Read More" */}
